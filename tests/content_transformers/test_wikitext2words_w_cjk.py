...
"""# Noqa
    assert list(wtpp.transform(text)) == \
        ['松山', '城', 'まつ', 'やま', 'じょう', 'は', '爱媛県', '松山市', 'に', 'あっ',
         ...
         '本丸', '南西', '麓', 'に', '二之丸', '続い', 'て', '叁之丸', '北麓', 'に', 'は',
         '北曲轮', '南东', '麓', 'に', '东', '曲轮', 'が', 'ある', '叁之丸', 'は', '比高',
        ...
        '石垣', '造', 'の', '虎口', 'を', '开く', '本丸', 'から', '二之丸', 'に', 'かけ',
         ...
         '史迹', '庭园', 'と', '叁之丸', '堀之内', 'を', '有する', '平山', '城', 'の', '築城',
         'に', '着手', 'し', 'た']
